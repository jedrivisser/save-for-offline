...
public class ScreenshotService extends Service {
    ...
    private final class ServiceHandler extends Handler {
        ...
        public void handleMessage(final Message msg) {
            ...
            boolean javaScriptEnabled = PreferenceManager.getDefaultSharedPreferences(
                    ScreenshotService.this).getBoolean("enable_javascript", true);
            ...
            webview.setWebViewClient(new WebViewClient() {
                ...
                public void onReceivedError(
                    ...
                    Log.w(
                            TAG,
                            "Recieved error from WebView, description: " + description + ", Failing url: " + failingUrl);
